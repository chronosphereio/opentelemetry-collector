...
import (
	...
	commonpb "go.opentelemetry.io/collector/data/opentelemetry-proto-gen/common/v1"
	otlp "go.opentelemetry.io/collector/data/opentelemetry-proto-gen/metrics/v1"
)
