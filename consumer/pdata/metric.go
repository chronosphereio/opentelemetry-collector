...
import (
	otlpcollectormetrics "go.opentelemetry.io/collector/data/opentelemetry-proto-gen/collector/metrics/v1"
	otlpmetrics "go.opentelemetry.io/collector/data/opentelemetry-proto-gen/metrics/v1"
)
